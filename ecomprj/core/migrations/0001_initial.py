    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghij1234560789', length=10, max_length=20, prefix='cat', unique=True)),
                ('title', models.CharField(default='product', max_length=100)),
                ('image', models.ImageField(default='categor.jpg', upload_to='category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghij1234567890', length=10, max_length=20, prefix='', unique=True)),
                ('title', models.CharField(default='this is the prod title', max_length=100)),
                ...
                ('price', models.DecimalField(decimal_places=2, default='1.99', max_digits=999999)),
                ('old_price', models.DecimalField(decimal_places=2, default='1.99', max_digits=999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghi0123456789', length=10, max_length=20, prefix='ven', unique=True)),
                ...
                ('address', models.CharField(default='123 Main road, India', max_length=100)),
                ('contact', models.CharField(default='+12 (345) 6789', max_length=100)),
